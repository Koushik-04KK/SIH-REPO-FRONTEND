...
const Dashboard = () => {
  ...
  const [isFault, setIsFault] = useState(false); // State to manage fault condition
      ...
      <div className="bg-customColor-otherpagesbackground w-full flex flex-col items-center py-8">
        <div className="bg-customColor-rmcardbackground rounded-lg shadow-xl p-4 md:p-6 lg:p-8 w-full max-w-[1300px]">
          <div className="flex flex-wrap justify-center items-center mb-8 md:justify-between">
            <button className="bg-[#387A79] text-white hidden md:block px-6 py-2 rounded-3xl hover:bg-teal-600 transition-all duration-300">
              Start Monitoring
            </button>
            <h1 className="text-lg md:text-2xl lg:text-3xl font-medium text-gray-700 text-center">
              REALTIME METRICS
            </h1>
            <button className="bg-[#BE4848] text-white hidden md:block px-6 py-2 rounded-3xl hover:bg-red-600 transition-all duration-300">
              Stop Monitoring
            </button>
          </div>
